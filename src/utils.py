...
def get_preprocessing(train, sr=16000, n_fft=1024, win_length=1024, hop_length=256, n_mels=80):
	return MelSpectrogram(sample_rate=sr, n_fft=n_fft, win_length=win_length, hop_length=hop_length, n_mels=n_mels)
